...
export default async function PnpkiPage({
  searchParams,
}: {
  ...
  return (
    <main className='flex flex-col gap-4'>
      <div className='flex flex-row justify-between items-end'>
        <div>
          <CardTitle className='text-xl'>PNPKI Metrics</CardTitle>
          <CardDescription>
            Track and monitor Public Key Infrastructure (PKI) activities,
            compliance, and implementation across the province.
          </CardDescription>
        </div>
        <div className='flex flex-row gap-2'>
          <ViewTargets bureauName='PNPKI' />
          <TargetsDialog />
          <FilterTerm />
        </div>
      </div>
      ...
      <Tabs defaultValue='overview' className='w-full col-span-4'>
        ...
        <TabsContent value='overview'>
          <DataTableProjects bureauName='PNPKI' searchParams={params} />
        </TabsContent>
